...
def start_gui():
    ...
    ent_gender = ttk.Entry(top_frame)
    ent_gender.grid(row=1, column=5, padx=5, pady=10)

    # Alignment
    lbl_alignment = ttk.Label(
