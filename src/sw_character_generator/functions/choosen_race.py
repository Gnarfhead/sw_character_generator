...
def choosen_race_modifiers(player_class: PlayerClass, race: str):
    ...
    if race_lower == "halfelf" and "halfelf" in player_class.allowed_races:
    ...
    elif race_lower == "dwarf" and "dwarf" in player_class.allowed_races:
    ...
    elif race_lower == "elf" and "elf" in player_class.allowed_races:
    ...
    elif race_lower == "halfling" and "halfling" in player_class.allowed_races:
    ...
    elif race_lower == "human" and "human" in player_class.allowed_races:
