...
def analyze_mod_str(strength: float, character_class: str):
    ...
    if 3 <= strength <= 4:
        ...
        strength_atck_mod = 1 if character_class == Profession.FIGHTER else 0
        ...
        strength_atck_mod = 1 if character_class == Profession.FIGHTER else 0
        strength_damage_mod = 1 if character_class == Profession.FIGHTER else 0
        ...
        strength_atck_mod = 2 if character_class == Profession.FIGHTER else 0
        strength_damage_mod = 2 if character_class == Profession.FIGHTER else 0
        return strength_atck_mod, strength_damage_mod, 15, 4
    elif strength == 18:
        #strength_atck_mod = 2 if character_class.name.lower() == "fighter" else 0
        #strength_damage_mod = 3 if character_class.name.lower() == "fighter" else 0
        strength_atck_mod = 2 if character_class == Profession.FIGHTER else 0
        strength_damage_mod = 3 if character_class == Profession.FIGHTER else 0
