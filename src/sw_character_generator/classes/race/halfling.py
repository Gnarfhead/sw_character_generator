...
def apply_halfling_dependent_modifiers(character):
    ...
    if not isinstance(character.special_abilities, set): # Ensure it's a set
        print("DEBUG apply_halfling_dependent_modifiers: Converting character.special_abilities to set from", type(character.special_abilities))
    ...
    # print("DEBUG apply_halfling_dependent_modifiers: type of character.special_abilities after assignment:", type(character.special_abilities))
    ...
    if not isinstance(character.immunities, set): # Ensure it's a set
        print("DEBUG apply_halfling_dependent_modifiers: Converting character.immunities to set from", type(character.immunities))
    ...
    # print("DEBUG apply_halfling_dependent_modifiers: type of character.immunities after assignment:", type(character.immunities))
