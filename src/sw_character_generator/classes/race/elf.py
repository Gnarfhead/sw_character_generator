def apply_elf_dependent_modifiers(character):
    ...
    if not isinstance(character.special_abilities, set): # Ensure it's a set
            print("DEBUG apply_elf_dependent_modifiers: Converting character.special_abilities to set from", type(character.special_abilities))
    ...
    if not isinstance(character.save_bonuses, set): # Ensure it's a set
        print("DEBUG apply_elf_dependent_modifiers: Converting character.save_bonuses to set from", type(character.save_bonuses))
    ...
    # print("DEBUG apply_elf_dependent_modifiers: type of character.save_bonuses after assignment:", type(character.save_bonuses))

    # Ensure immunities is a set
    if not isinstance(character.immunities, set): # Ensure it's a set
        print("DEBUG apply_elf_dependent_modifiers: Converting character.immunities to set from", type(character.immunities))
