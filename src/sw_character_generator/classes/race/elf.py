def apply_elf_dependent_modifiers(character):
    ...
    if not isinstance(character.immunity, set): # Ensure it's a set
        print("DEBUG apply_elf_dependent_modifiers: character.immunity is type", type(character.immunity))
    character.immunity.add("Ghulische Lähmung")
    print("DEBUG apply_elf_dependent_modifiers: type of character.immunity after assignment:", type(character.immunity))
    ...
    print("DEBUG apply_elf_dependent_modifiers: character.languages after assignment:", character.languages)
