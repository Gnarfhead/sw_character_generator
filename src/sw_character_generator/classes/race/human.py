...
def apply_human_dependent_modifiers(character):
    ...
    if not isinstance(character.special_abilities_race, set): # Ensure it's a set
        print("DEBUG apply_human_dependent_modifiers: Converting character.special_abilities to set from", type(character.special_abilities_race))
    ...
    # print("DEBUG apply_human_dependent_modifiers: type of character.special_abilities_race after assignment:", type(character.special_abilities_race))

    # Ensure save_bonuses is a set
    if not isinstance(character.save_bonuses_race, set): # Ensure it's a set
        print("DEBUG apply_human_dependent_modifiers: Converting character.save_bonuses to set from", type(character.save_bonuses_race))
    ...
    # print("DEBUG apply_human_dependent_modifiers: type of character.save_bonuses_race after assignment:", type(character.save_bonuses_race))

    # Ensure immunities is a set
    if not isinstance(character.immunities_race, set): # Ensure it's a set
        print("DEBUG apply_human_dependent_modifiers: Converting character.immunities to set from", type(character.immunities_race))
    ...
    # print("DEBUG apply_human_dependent_modifiers: type of character.immunities_race after assignment:", type(character.immunities_race))
