def apply_halfelf_dependent_modifiers(character):
    ...
    if not isinstance(character.save_bonuses, set): # Ensure it's a set
        print("DEBUG apply_halfelf_dependent_modifiers: Converting character.save_bonuses to set from", type(character.save_bonuses))
    ...
    # print("DEBUG apply_halfelf_dependent_modifiers: type of character.save_bonuses after assignment:", type(character.save_bonuses))
    ...
    if not isinstance(character.immunities, set): # Ensure it's a set
        print("DEBUG apply_halfelf_dependent_modifiers: Converting character.immunities to set from", type(character.immunities))
    ...
    # print("DEBUG apply_halfelf_dependent_modifiers: type of character.immunities after assignment:", type(character.immunities))
